...
class ResponsiveGamepadService {
  ...
  addTouchInput(element, inputType) {
    ...
    let touchInputId = createTouchInput(element, inputType, updateTouchpad.bind(this), this.keyMap, this.analogMaps, additionalArguments);
  ...
  removeTouchInput(touchInputId) {
    ...
    this.analogMaps.forEach(analogMapsKey => {
